...
<main>
    <div class="main">
        ...
        <header class="tag">
            <h1 class="container">Atualizar Reserva</h1>
        </header>
           ...
           <form action="reserva-update">
				...
				<div class="form-group mb-3">
					<label for="data" class="form-label"> Data </label> <input
						type="text" id="data" name="data" class="form-control" value="${reserva.data_reserva}" />
				</div>

				<div class="form-group mb-3">
					<label for="destino" class="form-label"> Destino </label> 
					<select id="destino" name="destino" class="form-control">
						<option value="${reserva.destino.nome}">${reserva.destino.nome}</option>
				...
				<div class="form-group mb-3">
					...
					<select id="usuario" name="usuario" class="form-control">
						<option value="${reserva.usuario.nome}">${reserva.usuario.nome}</option>
