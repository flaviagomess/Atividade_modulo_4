	...
	<div class="main">
		...
		<section class="container">
			...
			<div class="py-4">
				...
				<a href="reserva-getCreate" class="btn btn-primary mb-2 botao1"> Nova Reserva </a>
					...
					<tbody>
						...
						<jstl:forEach items="${listaReserva}" var="r">
							<tr>
								...
								<td>${r.destino.descricao}</td>
								<td>${r.usuario.nome}</td>
								<td>

								<div class="d-flex">
										<a href="reserva-edit?id=${r.id}" class="mx-1" title="Editar">
											<i class="ri-file-edit-line"></i>
										</a> 
										<a href="reserva-delete?id=${r.id}" class="mx-1" title="Cancelar"
