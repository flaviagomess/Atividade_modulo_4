	...
	<div class="main">
		...
		<section class="container">
			...
			<div class="py-4">
				...
				<a href="./views/destinos/create.html" class="btn btn-primary mb-2 botao1"> Novo Destino </a>
					...
					<jstl:forEach items="${listaDestinos}" var="d">
						<tr>
							...
							<td>
								...
								<div class="d-flex">
										<a href="destino-edit?id=${d.id}" class="mx-1" title="Editar">
											<i class="ri-file-edit-line"></i>
										</a> 
										<a href="destino-delete?id=${d.id}" class="mx-1" title="Cancelar"
											onclick="return confirm('Deseja excluir o usuário ${d.nome}.')">
